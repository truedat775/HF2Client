...
BOOL TeleportToVector(INT VectorType)
{
	...
	{
		Print(0, 0, "ÿc4ÿc4Lazarusÿc0: Failed to generate path, starting point is not a valid index");
		return FALSE;
	}
	...
	{
		Print(0, 4, "ÿc4Lazarusÿc0: ÿc1Failed to generate path, ending point is not a valid index");
		return FALSE;
	}
	...
	if (!Count)
	{
		Print(0, 4, "ÿc4Lazarusÿc0: ÿc1Failed to generate path, could not generate any nodes");
		return FALSE;
	}
